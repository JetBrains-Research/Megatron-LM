...
DSET_TYPE_CF = "codeformer"

DSET_TYPES = [DSET_TYPE_BERT, DSET_TYPE_ICT, DSET_TYPE_T5, DSET_TYPE_MULTIMODAL, DSET_TYPE_CF]
...
def get_a_and_b_segments(sample, np_rng):
    ...
    assert n_chunks > 1, "make sure each sample has at least two sentences."
    ...
    if n_chunks >= 3:
        ...
        a_end = np_rng.randint(1, n_chunks)
    tokens_a = []
...
def build_dataset(
    ...
    from megatron.data.codeformer_dataset import CodeformerDataset
    ...
    if dataset_type == DSET_TYPE_ICT:
        ...
        dataset = CodeformerDataset(
            ...
            masked_lm_prob=args.mask_prob,
            max_seq_length_dec=max_seq_length_dec,
            max_chunk_num=args.max_sent_num,
