...
def validate_args(args, defaults={}):
    ...
    if args.retro_add_retriever:
        ...
        with open(retro_args_path) as f:
            ...
            retro_args.retro_gpt_retrieved_length = args.retro_num_retrieved_chunks * retro_args.retro_gpt_chunk_length
...
def _add_retro_args(parser):
    ...
    group.add_argument(
        "--retro-return-doc-ids", action="store_true", help="Turn this on when preprocessing retro data."
    )
...
def _add_training_args(parser):
    ...
    group.add_argument("--profile-step-start", type=int, default=10, help="Gloable step to start profiling.")
    group.add_argument("--profile-step-end", type=int, default=12, help="Gloable step to stop profiling.")
...
def _add_data_args(parser):
    ...
    group.add_argument(
        ...
        type=int,
        default=None,
        help="Maximum second encoder sequence length to process.",
    )
